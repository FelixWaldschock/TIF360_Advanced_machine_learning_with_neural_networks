...
location = r'C:\Users\erikn\OneDrive - Chalmers\Advanced Machine Learning\HW_B\src\strategies'
...
if param_set==PARAM_TASK1a:
    strategy_file_Q= location + '/strategy_file_Q_1a.csv'
    strategy_file_S= location + '/strategy_file_S_1a.csv'
elif param_set==PARAM_TASK1b:
    strategy_file_Q= location + '/strategy_file_Q_1b.csv'
    strategy_file_S= location + '/strategy_file_S_1b.csv'
elif param_set==PARAM_TASK1c:
    strategy_file_Q= location + '/strategy_file_Q_1c.csv'
    strategy_file_S= location + '/strategy_file_S_1c.csv'
elif param_set==PARAM_TASK1d:
     strategy_file_Q=''
elif param_set==PARAM_TASK2a:
    strategy_file_Q=location + '/DQN_train'
...
if evaluate_agent:
    ...
    if isinstance(agent_evaluate,agentClass.TQAgent):
        agent_evaluate.fn_load_strategy(strategy_file_Q, strategy_file_S)
    if isinstance(agent_evaluate,agentClass.TDQNAgent):
        agent_evaluate.DQN_train.load_state_dict(torch.load(strategy_file_Q))
